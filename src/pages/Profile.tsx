    ...
    <div className={styles.page}>
      ...
      <div className={styles.panel}>
        ...
        <section className={styles.section}>
          ...
          >
            <svg className={styles.actionIcon} width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
              <path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z" />
              <polyline points="14 2 14 8 20 8" />
              <line x1="16" y1="13" x2="8" y2="13" />
              <line x1="16" y1="17" x2="8" y2="17" />
            </svg>
            <span className={styles.actionLabel}>我的主题</span>
            <svg className={styles.actionArrow} width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round">
          ...
          >
            ...
            <span className={styles.actionLabel}>退出登录</span>
          </button>
        </section>
